defmodule GitWrapper.StashEntry do
  @moduledoc """
  ...
  @doc """
  Parses the output of `git stash list` into a list of `GitWrapper.StashEntry` structs.
  ...
  ## Examples
      ...
      iex> GitWrapper.StashEntry.parse("stash@{0}: On main: my changes\\n")
      [%GitWrapper.StashEntry{index: 0, branch: "main", message: "my changes"}]

      iex> GitWrapper.StashEntry.parse("")
      []
