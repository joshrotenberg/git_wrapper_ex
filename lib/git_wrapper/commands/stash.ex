defmodule GitWrapper.Commands.Stash do
  @moduledoc """
  Implements the `GitWrapper.Command` behaviour for `git stash`.
  ...
  ## Examples
      ...
      iex> GitWrapper.Commands.Stash.args(%GitWrapper.Commands.Stash{})
      ["stash", "list"]

      iex> GitWrapper.Commands.Stash.args(%GitWrapper.Commands.Stash{save: true})
      ["stash", "push"]

      iex> GitWrapper.Commands.Stash.args(%GitWrapper.Commands.Stash{save: true, message: "wip"})
      ["stash", "push", "-m", "wip"]

      iex> GitWrapper.Commands.Stash.args(%GitWrapper.Commands.Stash{pop: true})
      ["stash", "pop"]

      iex> GitWrapper.Commands.Stash.args(%GitWrapper.Commands.Stash{drop: true, index: 1})
      ["stash", "drop", "stash@{1}"]
  ...
  For list operations (exit 0), parses each line into a `GitWrapper.StashEntry` struct.
