defmodule GitWrapper.Commands.Clone do
  @moduledoc """
  Implements the `GitWrapper.Command` behaviour for `git clone`.
  ...
  ## Examples
      ...
      iex> GitWrapper.Commands.Clone.args(%GitWrapper.Commands.Clone{url: "https://example.com/repo.git"})
      ["clone", "https://example.com/repo.git"]

      iex> GitWrapper.Commands.Clone.args(%GitWrapper.Commands.Clone{url: "https://example.com/repo.git", depth: 1})
      ["clone", "--depth=1", "https://example.com/repo.git"]

      iex> GitWrapper.Commands.Clone.args(%GitWrapper.Commands.Clone{url: "https://example.com/repo.git", branch: "main", depth: 1})
      ["clone", "--depth=1", "--branch=main", "https://example.com/repo.git"]

      iex> GitWrapper.Commands.Clone.args(%GitWrapper.Commands.Clone{url: "https://example.com/repo.git", directory: "my-repo"})
