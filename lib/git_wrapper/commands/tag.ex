defmodule GitWrapper.Commands.Tag do
  @moduledoc """
  Implements the `GitWrapper.Command` behaviour for `git tag`.
  ...
  ## Examples
      ...
      iex> GitWrapper.Commands.Tag.args(%GitWrapper.Commands.Tag{})
      ["tag", "-l", "--format=" <> GitWrapper.Tag.format_string()]

      iex> GitWrapper.Commands.Tag.args(%GitWrapper.Commands.Tag{create: "v1.0.0"})
      ["tag", "v1.0.0"]

      iex> GitWrapper.Commands.Tag.args(%GitWrapper.Commands.Tag{create: "v1.0.0", message: "release 1.0"})
      ["tag", "-a", "v1.0.0", "-m", "release 1.0"]

      iex> GitWrapper.Commands.Tag.args(%GitWrapper.Commands.Tag{delete: "v1.0.0"})
      ["tag", "-d", "v1.0.0"]
  ...
  For list operations (exit 0), parses each entry into a `GitWrapper.Tag` struct.
