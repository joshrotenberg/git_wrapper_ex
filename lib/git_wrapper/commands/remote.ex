defmodule GitWrapper.Commands.Remote do
  @moduledoc """
  Implements the `GitWrapper.Command` behaviour for `git remote`.
  ...
  - List with exit code 0: `{:ok, [%GitWrapper.Remote{}]}` (empty list when no remotes)
