defmodule GitWrapper.Commands.Merge do
  @moduledoc """
  Implements the `GitWrapper.Command` behaviour for `git merge`.
  ...
  ## Examples
      ...
      iex> GitWrapper.Commands.Merge.args(%GitWrapper.Commands.Merge{branch: "feature"})
      ["merge", "feature"]

      iex> GitWrapper.Commands.Merge.args(%GitWrapper.Commands.Merge{branch: "feature", no_ff: true})
      ["merge", "--no-ff", "feature"]

      iex> GitWrapper.Commands.Merge.args(%GitWrapper.Commands.Merge{abort: true})
      ["merge", "--abort"]
  ...
  For merge operations (exit code 0), parses into a `GitWrapper.MergeResult` struct.
