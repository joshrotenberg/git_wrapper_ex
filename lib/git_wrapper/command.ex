defmodule GitWrapper.Command do
  @moduledoc """
  ...
  Takes a module implementing the `GitWrapper.Command` behaviour, a command
  struct, and a `GitWrapper.Config`. Builds the full argument list, executes
